...
test.describe("Visual Debug", () => {
  test("should capture what is actually showing on pages", async ({ page }) => {
    ...
    console.log(
      "Home page has rebuild message:",
      homeContent.includes("Environment Rebuilt")
    );
    console.log(
      "Home page has login elements:",
      homeContent.includes("email") || homeContent.includes("login")
    );
    ...
    console.log(
      ...
      loginContent.includes('type="email"')
    );
    console.log(
      "Login page has login button:",
      loginContent.includes("Sign in") || loginContent.includes("Login")
    );
