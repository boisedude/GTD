...
test.describe('Task Capture', () => {
  ...
  test('should handle long task titles', async () => {
    const longTask = 'This is a very long task title that exceeds the normal length and should be handled gracefully by the application'
  ...
  test('should open detailed capture with Shift+Tab', async () => {
    ...
    await dashboardPage.expectTaskInList('Detailed shortcut task', 'captured-list')
  })
  ...
  test.describe('Auto-save functionality', () => {
    ...
    test('should restart auto-save timer when continuing to type', async ({ page }) => {
      // Start typing
