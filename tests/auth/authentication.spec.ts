...
test.describe('Authentication Flow', () => {
  ...
  test.describe('Email OTP Login', () => {
    ...
    test('should validate email format', async ({ page }) => {
      ...
      // Test valid email
      await page.fill('[data-testid="email-input"]', TEST_USERS.standard.email!);
    ...
    test('should send OTP and navigate to verification', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="email-hint"]')).toContainText(TEST_USERS.standard.email!);
    });
    ...
    test('should handle OTP verification', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="otp-error"]')).toContainText('Invalid verification code');
    ...
    test('should allow OTP resend', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="resend-otp-button"]')).toBeDisabled();
      ...
      await expect(page.locator('[data-testid="otp-resent-message"]')).toContainText('Code sent successfully');
    });
  ...
  test.describe('User Session Management', () => {
    ...
    test('should handle network issues during authentication', async ({ page }) => {
      await page.goto('/auth/login');
  ...
  test.describe('Security and Privacy', () => {
    ...
    test('should implement rate limiting for OTP requests', async ({ page }) => {
      await page.goto('/auth/login');
  ...
  test.describe('Accessibility', () => {
    ...
    test('should have proper ARIA labels and roles', async ({ page }) => {
      ...
      const errorId = await page.locator('[data-testid="email-error"]').getAttribute('id');
      const inputAriaDescribedBy = await page.locator('[data-testid="email-input"]').getAttribute('aria-describedby');
