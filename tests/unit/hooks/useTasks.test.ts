...
describe("useTasks", () => {
  ...
  describe("initialization", () => {
    ...
    it("should fetch tasks on mount when autoRefresh is true", async () => {
      mockSupabase
        .from()
        .single.mockResolvedValue(mockSupabaseResponses.tasks.select);
  ...
  describe("createTask", () => {
    ...
    it("should handle create task error", async () => {
      ...
      await act(async () => {
        await expect(result.current.createTask(taskInput)).rejects.toThrow(
          errorMessage
        );
      });
  ...
  describe("updateTask", () => {
    ...
    it("should handle update task error", async () => {
      ...
      await act(async () => {
        await expect(
          result.current.updateTask("task-1", updateInput)
  ...
  describe("deleteTask", () => {
    ...
    it("should handle delete task error", async () => {
      ...
      await act(async () => {
        await expect(result.current.deleteTask("task-1")).rejects.toThrow(
          errorMessage
        );
      });
