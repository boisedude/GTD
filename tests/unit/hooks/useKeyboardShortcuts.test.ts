...
describe('useKeyboardShortcuts', () => {
  ...
  describe('input element handling', () => {
    ...
    it('should allow escape and enter shortcuts in input elements', () => {
      ...
      act(() => {
        ...
        Object.defineProperty(escapeEvent, 'target', { value: input, enumerable: true })
      ...
      act(() => {
        ...
        Object.defineProperty(enterEvent, 'target', { value: input, enumerable: true })
  ...
  describe('target element handling', () => {
    it('should only listen to specific target element when provided', () => {
      ...
      renderHook(() => useKeyboardShortcuts(shortcuts, { targetElement, enableGlobal: false }))
