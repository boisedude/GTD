...
export const REVIEW_WORKFLOWS = {
  daily: {
    steps: [
      ...
      { id: 'task_triage', title: 'Review Today\'s Tasks', timeEstimate: '3 min' },
  ...
  weekly: {
    steps: [
      { id: 'welcome', title: 'Welcome to Weekly Review', timeEstimate: '2 min' },
      { id: 'calendar_check', title: 'Review Past Week Calendar', timeEstimate: '5 min' },
      { id: 'inbox_process', title: 'Process Inbox', timeEstimate: '15 min' },
      { id: 'project_review', title: 'Review All Projects', timeEstimate: '20 min' },
      { id: 'waiting_for_review', title: 'Review Waiting For', timeEstimate: '5 min' },
      { id: 'someday_review', title: 'Review Someday/Maybe', timeEstimate: '10 min' },
...
export const PERFORMANCE_TEST_DATA = {
  largeBatchTasks: Array.from({ length: 100 }, (_, i) => ({
    ...
    estimated_duration: ['5min', '15min', '30min', '1hour'][i % 4] as TaskDuration,
    priority: (i % 5) + 1,
...
export const ACCESSIBILITY_SCENARIOS = {
  keyboardNavigation: [
    ...
    { action: 'Shift+Tab', expected: 'Focus moves to previous interactive element' },
  ...
  screenReaderContent: [
    { element: 'task-item', expected: 'Task title, status, and context announced' },
    { element: 'capture-input', expected: 'Form field purpose and requirements announced' },
    { element: 'navigation', expected: 'Current page and available options announced' }
  ]
};
