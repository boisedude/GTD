...
test.describe("Accessibility Tests", () => {
  ...
  test.describe("Dashboard Accessibility", () => {
    ...
    test("should support keyboard navigation for task management", async ({
      page,
    }) => {
      const loginPage = new LoginPage(page);
      const dashboardPage = new DashboardPage(page);
    ...
    test("should support screen reader navigation of task lists", async ({
      page,
    }) => {
      const loginPage = new LoginPage(page);
      const dashboardPage = new DashboardPage(page);
    ...
    test("should have accessible modal dialogs", async ({ page }) => {
      ...
      await dashboardPage.captureTaskWithDetails(
        "Modal test task",
        "Test description"
      );
