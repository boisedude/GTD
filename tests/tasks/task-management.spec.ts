...
test.describe("Task Management", () => {
  ...
  test.describe("Task Editing", () => {
    test("should open task detail modal", async ({ page }) => {
      ...
      const taskItem = page.locator(
        '[data-testid="task-item"]:has-text("Test task for editing")'
      );
      ...
      ).toHaveValue("Test task for editing");
      await expect(
        page.locator('[data-testid="task-description-input"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="task-context-select"]')
      ).toBeVisible();
    });
    ...
    test("should update task title", async ({ page }) => {
      ...
      await expect(
        page.locator(`[data-testid="task-item"]:has-text("${originalTitle}")`)
      ).not.toBeVisible();
    });
    ...
    test("should update task description", async ({ page }) => {
      ...
      const taskItem = page.locator(
        '[data-testid="task-item"]:has-text("Task with description")'
      );
      await taskItem.click();
    ...
    test("should update task properties", async ({ page }) => {
      ...
      const taskItem = page.locator(
        '[data-testid="task-item"]:has-text("Task for property updates")'
      );
      await taskItem.click();
      ...
      await expect(
        page.locator('[data-testid="task-energy-select"]')
      ).toHaveValue("high");
      await expect(
        page.locator('[data-testid="task-duration-select"]')
      ).toHaveValue("1hour");
      await expect(
        page.locator('[data-testid="task-priority-select"]')
      ).toHaveValue("1");

      // Check tags
      await expect(
        page.locator('[data-testid="task-tag"]:has-text("urgent")')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="task-tag"]:has-text("work")')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="task-tag"]:has-text("important")')
      ).toBeVisible();
    });
    ...
    test("should validate required fields during edit", async ({ page }) => {
      ...
      const taskItem = page.locator(
        '[data-testid="task-item"]:has-text("Task to validate")'
      );
      await taskItem.click();
      ...
      await expect(
        page.locator('[data-testid="task-detail-modal"]')
      ).toBeVisible(); // Modal should stay open
    });
    ...
    test("should cancel edit without saving", async ({ page }) => {
      ...
      await expect(
        page
          .locator('[data-testid="task-item"]:has-text("Changed title")')
          .first()
      ).not.toBeVisible();
    });
    ...
    test("should auto-save drafts during editing", async ({ page }) => {
      ...
      const taskItem = page.locator(
        '[data-testid="task-item"]:has-text("Auto-save test task")'
      );
      await taskItem.click();
      ...
      await expect(
        page.locator('[data-testid="task-description-input"]')
      ).toHaveValue("Draft description content");
    });
  });
  ...
  test.describe("Task Status Transitions", () => {
    ...
    test("should complete task", async ({ page }) => {
      ...
      await expect(
        completedTask.locator('[data-testid="completed-date"]')
      ).toBeVisible();
    });
    ...
    test("should track status change history", async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="status-history"]')
      ).toBeVisible();

      // Should show transitions
      await expect(
        page.locator('[data-testid="history-item"]:has-text("next_action")')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="history-item"]:has-text("waiting_for")')
      ).toBeVisible();
    });
  });

  test.describe("Task Completion", () => {
    test("should complete task with swipe action on mobile", async ({
      page,
    }) => {
      ...
      await expect(
        page.locator('[data-testid="task-completed-toast"]')
      ).toBeVisible();
    });
    ...
    test("should show completion celebration", async ({ page }) => {
      ...
      ).toContainText(/well done|completed|great job/i);
    });
    ...
    test("should handle bulk task completion", async ({ page }) => {
      ...
      for (const task of tasks) {
        await expect(
          page.locator(
            `[data-testid="task-item"][data-status="completed"]:has-text("${task}")`
          )
        ).toBeVisible();
      }
    });
    ...
    test("should allow uncompleting tasks", async ({ page }) => {
      ...
      await expect(
        page.locator(
          `[data-testid="task-item"][data-status="captured"]:has-text("${taskTitle}")`
        )
      ).toBeVisible();
    });
  });
  ...
  test.describe("Task Deletion", () => {
    ...
    test("should provide undo for recently deleted tasks", async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="delete-undo"]')).toContainText(
        /undo|restore/i
      );
  ...
  test.describe("Task Duplication", () => {
    test("should duplicate task", async ({ page }) => {
      ...
      await expect(
        page.locator(
          `[data-testid="task-item"]:has-text("Copy of ${originalTitle}")`
        )
      ).toBeVisible();
    ...
    test("should create recurring task template", async ({ page }) => {
      ...
      await taskItem.click();
      await expect(
        page.locator('[data-testid="task-status-select"]')
      ).toHaveValue("captured");
    });
  });

  test.describe("Performance", () => {
    test("should handle task operations within performance thresholds", async ({
      page,
    }) => {
      await page.goto("/dashboard");
      ...
      expect(createTime).toBeLessThan(
      ...
      const taskItem = page.locator(
        '[data-testid="task-item"]:has-text("Performance test task")'
      );
      await taskItem.click();
      await page.fill(
        '[data-testid="task-description-input"]',
