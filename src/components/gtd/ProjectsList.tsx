...
export function ProjectsList({
  ...
  const handleProjectComplete = async (projectId: string, completed: boolean) => {
  ...
  const handleProjectDelete = async (projectId: string) => {
    ...
    if (projectTasks.length > 0) {
      alert(`Cannot delete project with ${projectTasks.length} tasks. Please reassign or delete tasks first.`)
      return
    }
  ...
  return (
    <div className={cn('space-y-6', className)}>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{projectStats.active}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{projectStats.tasksInProjects}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{projectStats.completionRate}%</p>
              </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Tabs value={selectedView} onValueChange={(value) => setSelectedView(value as ProjectView)}>
          <TabsList>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="mx-auto w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                {searchQuery ? <Archive className="h-6 w-6 text-purple-600" /> : <Plus className="h-6 w-6 text-purple-600" />}
              </div>
              <div>
        ...
        <Card className="border-l-4 border-yellow-200">
          ...
          <CardContent>
            <p className="text-sm text-gray-600 mb-4">
              These tasks aren't assigned to any project. Consider organizing them into projects or converting them to standalone actions.
            </p>
