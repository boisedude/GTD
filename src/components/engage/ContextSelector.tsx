...
import type { EngagementContext, TaskEnergyLevel, TaskDuration } from '@/types/database'
import {
  MapPin,
  Battery,
  Clock,
...
export function ContextSelector({ context, onContextChange, className }: ContextSelectorProps) {
  const [isExpanded, setIsExpanded] = useState(false)

  const currentLocation = locationOptions.find(opt => opt.value === context.current_location)
  const currentEnergy = energyOptions.find(opt => opt.value === context.current_energy)
  const currentTime = timeOptions.find(opt => opt.value === context.available_time)
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                {currentEnergy && (
                  <>
                    <currentEnergy.icon className={`h-4 w-4 ${currentEnergy.color}`} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => onContextChange({ current_location: value as 'home' | 'office' | 'mobile' })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => onContextChange({ current_energy: value as TaskEnergyLevel })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => onContextChange({ available_time: value as TaskDuration })}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
