      ...
      <div className="max-w-4xl text-center space-y-12">
        <div className="space-y-6">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            A productivity app inspired by David Allen&apos;s Getting Things Done methodology.
            Capture, clarify, organize, reflect, and engage with your tasks stress-free.
          </p>
        ...
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-gray-900">Why Choose GTD App?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="text-center space-y-3">
              <CheckCircle className="h-8 w-8 text-green-600 mx-auto" />
              <h3 className="font-semibold">Fast Capture</h3>
              <p className="text-sm text-gray-600">Quickly capture thoughts and tasks in under 5 seconds</p>
            </div>
            <div className="text-center space-y-3">
              <CheckCircle className="h-8 w-8 text-green-600 mx-auto" />
              <h3 className="font-semibold">Mobile First</h3>
              <p className="text-sm text-gray-600">Designed for thumb-friendly interactions on any device</p>
            </div>
            <div className="text-center space-y-3">
              <CheckCircle className="h-8 w-8 text-green-600 mx-auto" />
              <h3 className="font-semibold">Privacy Focused</h3>
              <p className="text-sm text-gray-600">Your data is yours - secure and private by design</p>
            </div>
          </div>
        </div>
