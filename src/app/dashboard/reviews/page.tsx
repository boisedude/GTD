...
import { AICoachingSystem, ReviewReminder } from '@/components/reviews/AICoachingSystem'
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">
                    {recentReviews.length > 0 ?
                      Math.round(recentReviews.reduce((sum, r) => sum + (r.duration_minutes || 0), 0) / recentReviews.length) :
                      0
                    }
                  </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>Quick 5-10 minute check-in</CardDescription>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-gray-600">
                  Review today&apos;s commitments, triage tasks, and plan for tomorrow.
                  Essential for staying on top of your daily workflow.
                </p>
                ...
                >
                  ...
                  {isReviewing && currentSession?.type === 'daily' ? 'Resume Daily Review' : 'Start Daily Review'}
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-gray-600">
                  The backbone of GTD. Process your inbox, review projects,
                  and ensure your system is current and trustworthy.
                </p>
                ...
                >
                  <Play className="h-4 w-4 mr-2" />
                  {isReviewing && currentSession?.type === 'weekly' ? 'Resume Weekly Review' : 'Start Weekly Review'}
                </Button>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-medium text-green-900 mb-2">GTD Review Best Practices</h3>
                <div className="space-y-2 text-sm text-green-700">
                  <p>• <strong>Daily reviews:</strong> Keep them short (5-10 min) and focused on today&apos;s commitments</p>
                  <p>• <strong>Weekly reviews:</strong> Block distraction-free time, aim for completeness over speed</p>
                  <p>• <strong>Consistency:</strong> Better to do quick reviews regularly than perfect reviews occasionally</p>
                  <p>• <strong>Trust the system:</strong> Your GTD system only works if you maintain it through reviews</p>
                </div>
                <p className="text-xs text-green-600 mt-3 italic">
                  &quot;The Weekly Review is the backbone of the GTD workflow.&quot; - David Allen
                </p>
              </div>
            </div>
          </CardContent>
